...
// UID is method to generate a virtual unique indentifier for whole system
// its structure contant 62 bit: LocalID - ObjectType - ShardID
// 32bit for Local ID
// 10bit for Object Type
// 18bit for Shard ID
type UID struct {
	localID    uint32
	objectType int
